      ...
      <div className="flex-1 relative flex items-center justify-center min-h-0">
        ...
        {!hasStarted ? (
          ...
          <div className="relative z-10 flex flex-col items-center">
            {/* The Orb */}
            <div
              className={`relative flex items-center justify-center rounded-full transition-all duration-700 ${currentState.size} ${currentState.style}`}
            >
              {aiState === "speaking" && (
              ...
              {(aiState === "idle" || aiState === "listening") &&
                (aiState === "listening" ? (
                  <div className="relative flex items-center justify-center">
                    <div
                      className={`absolute inset-0 rounded-full bg-chart-2/20 transition-all duration-300 ${isUserSpeaking ? "animate-ping scale-110" : "animate-pulse scale-100"}`}
                    />
                    <Mic
                      className={`relative z-10 h-12 w-12 text-chart-2 transition-transform duration-200 ${isUserSpeaking ? "scale-110" : "scale-100"}`}
                    />
                  </div>
                ) : (
